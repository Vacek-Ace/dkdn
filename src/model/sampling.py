...
def hyperparameter_selection_adjustment(X_train, y_train, smpl_cuts, cuts, method, grid_params, complexity, samples_scores, samples_params, samples_idx, rng_seed, highest_complexity_class_idx, p):
